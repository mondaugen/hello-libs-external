hello-libs-external
=========
hello-libs-external is a sample that shows you how to manage 3rd party C/C++ libraries with Android Studio.
To see how to include `libtest.so`, see `app/build.gradle`,
`app/src/main/cpp/CMakeLists.txt`, and
